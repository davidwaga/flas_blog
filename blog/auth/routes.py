...
from blog.auth.forms import (RegistrationForm, LoginForm, UpdateAccountForm, RequestResetForm,
                                      ResetPasswordForm)
...
def account():
    ...
    return render_template('account.html', title='Account settings', image_file=image_file, form=form)
